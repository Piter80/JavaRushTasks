...
public  class Beach implements Comparable<Beach> {
    ...
    public synchronized int compareTo(Beach o) {
        int tmp = 0;
        if (this.getQuality() > o.getQuality()) tmp+= 2;
        else if (this.getQuality() < o.getQuality()) tmp-= 2;

        if (this.getDistance() > o.getDistance()) tmp++;
        else if (this.getDistance() < o.getDistance()) tmp--;
    ...
    public static void main(String[] args) {
        Beach a = new Beach("a",500, 6);
        Beach b = new Beach("b",500, 6);
